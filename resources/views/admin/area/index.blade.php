...
<div class="top-menu">
 ...
 <div class="col-sm-7">
  <ul class="nav nav-pills pull-right page-top-navigation">
    <li><a href="{{ route('dashboard.area.create') }}"><i class="fa fa-plus"></i> Add new</a></li>
    ...
    <li class="active"><a href="#"><i class="fa fa-code-branch"></i> Areas</a></li>
  </ul>
</div>
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="input-group">
                      <input type="text" class="form-control search-slt" id="searchGlobal" placeholder="Search...">
                      <div class="input-group-btn">
                        <button type="button" id="search" class="btn btn-warning wrn-btn">Search</button>
                      </div>
                  </div>
                </div>
                <div class="clearfix"></div>
...
<script type="text/javascript">
    var url = "{{ route('dashboard.area.index') }}";
//
...
$.fn.dataTable.pipeline = function ( opts ) {
    ...
    var conf = $.extend( {
        ...
        url: "{{ route('dashboard.area.index') }}",      // script url
...
$(function(){
    ...
    var table = $('#dataTable').DataTable( {
      ...
      "columnDefs": [
      {"targets": [2,3,4], "searchable": false, "orderable": false, "visible": true}
      ],
      "order": [[0, 'asc']]
  } );
